...
class Aluno(models.Model):
    ...
    curso = models.ForeignKey(Curso, on_delete=models.CASCADE, related_name="alunos", verbose_name="Curso")
    campus = models.ForeignKey(Campus, on_delete=models.CASCADE, related_name="alunos", verbose_name="Campus")
